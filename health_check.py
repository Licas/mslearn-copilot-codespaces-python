#!/usr/bin/env python3
"""
Health check script that pings the /health endpoint and prints the result.
"""
import requests
import sys
...
def health_check(url: str = "http://localhost:8000/ping") -> bool:
    """
    Ping the health endpoint and return True if healthy, False otherwise.
    
    Args:
        url: The health endpoint URL (defaults to localhost:8000/ping)
